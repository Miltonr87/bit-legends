...
export const sportsGames: Game[] = [
    {
        ...
        longDescription:
            "Brasileiro 2024 is a passionate fan-made hack created by Falcon BR that transforms the classic International Superstar Soccer into a modern celebration of Brazilian football. " +
            "Featuring updated kits, new stadiums, and complete 2024 rosters from iconic clubs like Flamengo and Palmeiras, this edition captures the true spirit of Série A. " +
            "With improved AI, authentic Brazilian visuals, and the same fast-paced arcade rhythm that defined 16-bit football, this ROM hack blends nostalgia with today’s competitive energy — a true love letter to the legacy of Brazilian football and its fans.",
        players: "1-2 Players",
        developer: "Falcon BR",
    ...
    },
    {
        ...
        longDescription:
            "Brasileiro 2025 is a premium fan-made hack developed by the BSTAR TEAM, enhancing the legendary International Superstar Soccer with a complete overhaul of the 2025 Brazilian Championship. " +
            "It features fully updated rosters, redesigned kits, improved stadium atmospheres, and refined gameplay balance while preserving the iconic essence of 16-bit football. " +
            "Authentic club identities, modern lineups, and community-driven polish come together to deliver the most up-to-date Brazilian football experience on the SNES. " +
            "A faithful tribute to the nation’s football culture, crafted by dedicated modders for passionate fans.",
        players: "1-2 Players",
    ...
    },
    {
        ...
        longDescription:
            "World Cup Mexico 70 (Hack) is a fan-made tribute created by Falcon BR that transports players back to the golden age of football. " +
            "Built on the classic SNES football engine, this ROM hack recreates the legendary 1970 World Cup in a stunning 16-bit format, featuring authentic national teams, period-accurate kits, and the iconic sunlit stadiums of Mexico. " +
            "Step onto the pitch as Pelé, Tostão, Jairzinho, and Rivelino leading Brazil’s unforgettable squad to immortality, accompanied by nostalgic commentary and roaring crowd chants. " +
            "Every pass, goal, and celebration is filled with historical authenticity and emotion, capturing the fluid beauty and joy of the world’s most iconic tournament. " +
            "From tactical duels to explosive counterattacks, this ROM hack reimagines the magic of the World Cup for retro gaming fans.",
        players: "1-2 Players",
        developer: "Falcon BR",
    ...
    },
    {
        ...
        longDescription:
            "Futebol Brasileiro 96 (1996) is a nostalgic Brazilian edition from the 16-bit era of the 1996 Brazilian Championship, capturing the golden age of SNES football games. " +
            "Developed by Peruvian programmer Lobsang Alvites (Mr. Byte) and localized by TecToy, this version highlights the passion of Brazil’s national teams and iconic clubs of the mid-’90s. " +
            "Featuring energetic commentary — albeit in Spanish — and fast-paced gameplay powered by Konami’s unmistakable football engines, the game delivers an authentic and vibrant portrayal of how Brazil played, celebrated, and lived football in the ’90s. " +
            "A must-play for retro sports fans and lovers of Brazilian football history.",
        players: "1-2 Players",
    ...
    },
    {
        ...
        longDescription:
            "FIFA Club World Cup 2025 is a ROM hack built on the classic EFRA 16-bit engine, recreating the global tournament with full rosters, refreshed visuals, and refined Konami-style gameplay. " +
            "This edition features clubs from every continent — from European giants like Real Madrid and Manchester City to South American favorites Flamengo and Palmeiras — all presented with updated kits, modern lineups, and beautifully stylized 16-bit stadiums. " +
            "The game delivers a fast, competitive, and atmospheric experience, capturing the prestige of the Club World Cup with vibrant animations, passionate crowds, and that nostalgic charm typical of Brazilian ROM hacks. " +
            "A global celebration of football adapted to the retro style — perfect for fans of international tournaments and classic modded editions.",
        players: "1-2 Players",
...
export const sportsFilters = ["Sport", "Horror"];
